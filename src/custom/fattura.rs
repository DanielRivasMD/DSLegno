...
impl FatturaToCapture {
	pub fn upload_formatter_acquisti(
		&self,
	) -> anyResult<Vec<FatturaToUploadAcquisti>> {
	...
	pub fn upload_formatter_vendite(
		&self,
	) -> anyResult<Vec<FatturaToUploadVendite>> {
